#!/usr/bin/env python3
"""Extract the frozen Ada-RCA representation without reading labels."""
...
def main():
    ...
    parser.add_argument("--source-root", required=True, help="source bundles made by prepare_dataset.py")
    parser.add_argument("--output-root", required=True, help="directory for generated feature files")
    ...
    (output_root / "extraction_summary.json").write_text(json.dumps(final, indent=2, sort_keys=True) + "\n", encoding="utf-8")
